...
void World::buildWorld(unsigned int worldId, const std::shared_ptr<ModelManager>& modelManager, const std::shared_ptr<ShaderManager>& shaderManager)
{
	...
	const std::string shaderFilePath = "Resources/Shaders/basic.shader";
